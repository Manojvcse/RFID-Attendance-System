...
const char* ssid = "Samsung Galaxy F12";
const char* password = "manoj051";
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
void loop() {
  ...
  digitalWrite(ON_Board_LED, LOW);
    ...
    http.begin(client, "http://192.168.21.34/NodeMCU_RC522_Mysql/getUID.php");  //Specify request destination
